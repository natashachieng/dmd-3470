...
Add a hamburger menu for small screens — the navbar links are hidden on mobile right now.
</todo>

<todo id="animations">
Scroll animations
Add fade-in / slide-up animations as sections come into view using Intersection Observer.
</todo>

<todo id="scent-quiz">
Scent quiz / personalization flow
Add an interactive quiz that helps users discover their scent profile before subscribing.
</todo>

<todo id="seo">
SEO & meta tags
Add proper title, description, and OG meta tags in index.html for shareability.
</todo>

<todo id="past-scents-page">
Past scents archive page
Create a dedicated /archive route showcasing past monthly vials with descriptions.
</todo>
